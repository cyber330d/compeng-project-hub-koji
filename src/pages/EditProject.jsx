...
const EditProject = () => {
  ...
  return (
    <>
      <NavBar />
      <div className="container mx-1 mt-10 mb-20">
        <div className="bg-gray-100 w-full md:w-8/12 m-auto">
            ...
            {project ? (
              <form onSubmit={submitUpdated}>
                ...
                <div className="m-2 border p-1">
                  <label htmlFor="projectTitle" className="text-gray-500 p-1 font-bold text-sm block">
                    Project Title
                  </label>
                  <textarea name="projectTitle" id="projectTitle" className="w-full" placeholder="Correctly state your project title" value={formData.projectTitle} onChange={handleInputChange}></textarea>
                </div>
                <div className="m-2 border p-1">
                  <label htmlFor="projectSummary" className="text-gray-500 p-1 font-bold text-sm block">
                    Project Summary
                  </label>
                  <textarea name="projectSummary" id="projectSummary" className="w-full" placeholder="Correctly state your project summary" value={formData.projectSummary} onChange={handleInputChange}></textarea>
                </div>
                <div className="m-2 border p-1">
                  <label htmlFor="projectVision" className="text-gray-500 p-1 font-bold text-sm block">
                    Vision
                  </label>
                  <textarea name="projectVision" id="projectVision" className="w-full" placeholder="Correctly state your project vision" value={formData.projectVision} onChange={handleInputChange}></textarea>
                </div>
                <div className="m-2 border p-1">
